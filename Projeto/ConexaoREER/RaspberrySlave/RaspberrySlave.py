...
dadosDaRede = ["", ":wifi-slave", ":ESP32-Master", ":123456789"]
...
while True:
    ...
    if (estadoRaspberry == 1):
        ...
        adicionarLinhaOLED("Conectando Rede")
        estadoRaspberry = 7
        ...
        adicionarLinhaOLED("Rede conectada")
        estadoRaspberry = 9
    
    elif (estadoRaspberry == 9):
        
        if (mensagemParaMaster):
            mensagemParaMaster = False
            uart.write("C08:Mensagem do Slave")
        else:
            mensagemParaMaster = True
            uart.write("C06")
