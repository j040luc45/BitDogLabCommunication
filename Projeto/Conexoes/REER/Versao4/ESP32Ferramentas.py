...
class ESP32Ferramentas:
    ...
    def executarEtapa(self):
        ...
        if (self.estado == 0):
            ...
            elif (self.dadosDaRede[1] == ":lora-master"):
                if (self.estado == 5):
                    if (self.enviarDadosDaRede()):
                        self.estado = 6
                        self.tempoMaximoNaoRetorno = 10000
                    ...
                    tempoMaximoNaoRetorno = self.dadosDaRede[3]
                    self.tempoMaximoNaoRetorno = int(tempoMaximoNaoRetorno[1:])
                    self.tempoMensagemSerial = self.tempoMaximoNaoRetorno // 4
            ...
            elif (self.dadosDaRede[1] == ":lora-slave"):
                if (self.estado == 5):
                    if (self.enviarDadosDaRede()):
                        self.estado = 6
            ...
            elif (self.dadosDaRede[1] == ":lorawan-uplink"):
                if (self.estado == 5):
                    if (self.enviarDadosDaRede()):
                        self.estado = 6
